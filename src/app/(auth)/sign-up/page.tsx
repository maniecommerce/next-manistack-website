  ...
  useEffect(() => {
    ...
    const fetchCheck = async () => {
      ...
      try {
        ...
        if (!ignore) {
          setEmailMessage(
            e.response?.data?.message || "Email check failed"
          );
        }
      } finally {
        if (!ignore) {
        ...
        <Form {...form}>
          ...
          >
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      className="bg-gray-50 border border-gray-300 px-4 py-6 rounded-xl focus:ring-2 focus:ring-blue-300"
                    />
                  </FormControl>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-blue-600 text-sm"
                      >
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="w-full py-6 bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-lg font-bold rounded-xl hover:scale-[1.02] transition shadow-md"
            >
              {submitting ? (
                <>
